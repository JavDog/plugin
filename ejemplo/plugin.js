...
(function ($) {
    ...
    $.extend(window.OfscPlugin.prototype, {
        ...
        pluginOpen: function (receivedData) {
            ...
            $('.back_method_select, .back_activity_id, .back_plugin_label, .back_plugin_params').on('change', function () { //IE10+
                this._updateResponseJSON();
            }.bind(this));
        ...
        processProcedureResult(element, receivedJson) {
        ...
        init: function () {
            ...
            $('.inlineDatos').click(function(){
                 
            }.bind(this));

            $('.inlinePruebas').click(function(){
                alert("Boton Pruebas");
            }.bind(this));

            $('.inlineProd').click(function(){
                alert("Boton Productos");
            }.bind(this));

            $('.inlineObs').click(function(){
                alert("Boton Observaciones");
            }.bind(this));
        }
    });
